	...
	<body>
		...
		<div class="container-fluid text-center">
			...
			<div class="row mt-3 mb-3">
				<div class="col-md-12">
					<!--Login Form-->
					<form action="Student_Login" id="slogin-form" class="login-form pl-4 pr-4" method="post" onsubmit="return validateFormData()">
						...
						<!--Applicant ID Text Box-->
						<input class="form-control mb-3" type="text" id="applicant_id" name="applicant_id" placeholder="Your Username" onkeyup="applicantIdValidation();" oncopy="return false" onpaste="return false" oncut="return false" ondrop="return false" autocomplete="off" maxlength="8">
						<!--Client Side Validation Error for Application ID-->
						<p id="applicant_id_check"></p>

						<!--Student Password Text Box-->
						<div class="input-group mb-3">
							<input type="password" class="form-control" id="student_password" name="student_password" placeholder="Your Password" onkeyup="studentPasswordValidation();" oncopy="return false" onpaste="return false" oncut="return false" ondrop="return false" autocomplete="off" maxlength="15">
						...
						<a class="fp-link" href="sforgot_password.jsp">Forgot Password</a>
					</form>
				</div>
			</div>
		</div>
