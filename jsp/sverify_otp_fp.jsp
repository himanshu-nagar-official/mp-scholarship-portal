...
<html lang="en">
	...
	<body>
		...
		<!--Message & Student Forgot Password OTP Verification Form-->
		<div class="container mt-0 text-center">
			...
			<% 
				if(!(request.getAttribute("message")==null))
				{
					...
					if(request.getAttribute("message").equals("A 6 digit One-Time-Password(OTP) is sent to your registered email id."))
					{
			%>
						<!--Show Message-->
			...
			<!--Student Forgot Password OTP Verification Form-->
			<form method="post" onsubmit="return validateFormData()" class="border pr-2 pl-2 mb-4">
				<div class="row">
					<div class="col-md-3"></div>
					<!--OTP Input Text Box-->
					<div class="col-md-6">
						<label class="form-label float-left" for="otp">Enter 6 Digit OTP:</label>
						<input type="hidden" class="form-control mb-3" id="otp" name="otp" onkeyup="studentOTPValidation();" oncopy="return false" onpaste="return false" oncut="return false" ondrop="return false" maxlength="6" minlength="6">
						<div class="input-group">
						  <input id="otp1" type="text" class="form-control text-center" onkeyup="studentOTPValidation();" maxlength="1" style="letter-spacing: 10px;">
						  <b style="font-size: 25px;">-</b>
						  <input id="otp2" type="text" class="form-control text-center" onkeyup="studentOTPValidation();" maxlength="1" style="letter-spacing: 10px;">
						  <b style="font-size: 25px;">-</b>
						  <input id="otp3" type="text" class="form-control text-center" onkeyup="studentOTPValidation();" maxlength="1" style="letter-spacing: 10px;">
						  <b style="font-size: 25px;">-</b>
						  <input id="otp4" type="text" class="form-control text-center" onkeyup="studentOTPValidation();" maxlength="1" style="letter-spacing: 10px;">
						  <b style="font-size: 25px;">-</b>
						  <input id="otp5" type="text" class="form-control text-center" onkeyup="studentOTPValidation();" maxlength="1" style="letter-spacing: 10px;">
						  <b style="font-size: 25px;">-</b>
						  <input id="otp6" type="text" class="form-control text-center" onkeyup="studentOTPValidation();" maxlength="1" style="letter-spacing: 10px;">
						</div>
						<!--Client Side Validation Error for OTP-->
						<p id="otp_check" class="text-danger"></p>

						<!--Hash Key Input Hidden Box-->
						<input type="hidden" name="hash_key" id="hash_key" value="${requestScope.hash_key}">

						<!--Verify OTP Button-->
						<input type="submit" name="verify_otp" class="btn btn-primary mt-2 mb-2" value="Verify OTP">

						<!--Note for User-->
						<p class="text-info">Note: OTP is Valid for 10 Minutes Only.</p>
					</div>
				</div>
			</form>
		</div>
		...
		<script src="../js/sverify_otp_fp.js"></script>
	</body>
</html>