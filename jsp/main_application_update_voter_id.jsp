...
<%
	...
	//Local Variables Declaration for Student Voter Id
	String voter_id = "";
...
<html lang="en">
	...
	<body>
				...
				<div class="col-md-10">
					<div class="card">
						<div class="card-header">
							Update Student's Voter Id Number
						</div>
						<div class="card-body text-center">
					  		<div class="alert alert-primary text-left">
								<h6>
									HELP - Page facilitates updation of Voter Id Number
								</h6>
							</div>

							<hr>

							<!--If Voter Id Stored Successfully Show Modal-->
							<%
								if(request.getAttribute("message")!=null)
								{
							%>
									<!-- Modal -->
									<div id="update_voter_id_modal" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
									  <div class="modal-dialog">

									    <!-- Modal content-->
									    <div class="modal-content">
									      <div class="modal-header alert alert-success">
									        <div class="modal-title text-center">Message : Student Voter Id</div>
									...
									<script type="text/javascript">
										$("#update_voter_id_modal").modal();
									</script>
							<%
								}
							%>

                			<form method="post" onsubmit="return validateFormData()" action="Update_Student_Voter_Id">
                				<table class="table table-bordered">
                					<!--Input Type Text Box for Voter Id Number-->
                					<tr>
                						<td class="text-right">
                							<label class="form-label" for="voter_id">Voter Id Number:</label>
                						</td>
                						<td class="text-left">
                							<input class="form-control mb-3" type="text" id="voter_id" name="voter_id" placeholder="Voter Id" onkeyup="return voterIdValidation();" oncopy="return false" onpaste="return false" oncut="return false" ondrop="return false" autocomplete="off" maxlength="10" value="<%=voter_id%>">
                						</td>
                					</tr>
                					...
                					<tr>
                						<td colspan="2">
											...
											<p id="voter_id_check" class="text-danger"></p>
                						</td>
                					</tr>
                					...
                					<tr>
                						<td colspan="2">
                							<input class="btn btn-success mt-2" type="submit" name="update_voter_id" value="Save Details">
                						</td>
                					</tr>
                				</table>
                        	</form>
		...
		<script src="../js/main_application_update_voter_id.js"></script>	
	</body>
</html>