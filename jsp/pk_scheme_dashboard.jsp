...
<%
	...
	{  
		...
		if(!con.isClosed())
		{
			...
			if(!student_gender.equals("Female"))
			{
		...
		<div class="container border mb-4">
			<div class="container mt-4 mb-4">
				<div class="alert alert-success text-center">
					...
					<h5 class="text-primary">Pratibha Kiran</h5>
					<h2 class="border border-info">Schemes Benefits</h2>
					<h5 class="text-primary">This 'Scheme' is for the Girls who got more than 60% of marks in 12th Examination and She belongs to Urban Areas.</h5>
				</div>
			</div>
