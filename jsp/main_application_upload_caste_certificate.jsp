...
<%
	...
	//Get Student Caste Certificate Image Path
	String casteCertificatePath = applicationPath+"/uploads/images/student_caste_certificate/"+applicant_id+".png";

	//Creating Student Caste Certificate Image File Object
	File student_caste_certificate = new File(casteCertificatePath);

	//Local Variables Declaration for Student Caste Certificate Number
	String caste_certificate_number = "";
	...
	{  
		...
		if(!con.isClosed())
		{
			...
			caste_certificate_number = rs.getString("caste_certificate_number");
			if(caste_certificate_number==null)
			{
...
<html lang="en">
	...
	<body>
				...
				<div class="col-md-10">
					<div class="card">
						<div class="card-header">
							Caste Certificate : Upload Scanned Image Of Certificate in JPG / JPEG Or PNG format & Size should not be more than 100 Kb
						</div>
						<div class="card-body text-center">
					  		<div class="alert alert-primary text-center">
								<h6>
									Instructions: Upload the scanned copy (in JPG/JPEG Or PNG format only) of your caste certificate from here, the size of scan copy should not exceed 100 KB, other details (enter caste certificate number also).
								</h6>
							</div>

							<hr>

							<!--If Caste Certificate Details Stored Successfully Show Modal-->
							<%
								if(request.getAttribute("message")!=null)
								{
							%>
									<!-- Modal -->
									<div id="upload_caste_certificate_modal" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
									  <div class="modal-dialog">

									    <!-- Modal content-->
									    <div class="modal-content">
									      <div class="modal-header alert alert-success">
									        <div class="modal-title text-center">Message : Student Caste Certificate Upload</div>
									...
									<script type="text/javascript">
										$("#upload_caste_certificate_modal").modal();
									</script>
							<%
								}
							%>

                			<form method="post" onsubmit="return validateFormData()" action="Upload_Caste_Certificate" enctype="multipart/form-data">
                				<table class="table table-bordered">
                					<!--Input Type Text Box for Caste Certificate Number-->
                					<tr>
                						<td class="text-right">
                							<label class="form-label" for="caste_certificate_number">Caste Certificate Number:</label>
                						</td>
                						<td class="text-left">
                							<input class="form-control mb-3" type="text" id="caste_certificate_number" name="caste_certificate_number" placeholder="Caste Certificate Number" onkeyup="return casteCertificateNumberValidation();" oncopy="return false" onpaste="return false" oncut="return false" ondrop="return false" autocomplete="off" value="<%= caste_certificate_number %>">
                						</td>
                					</tr>

                					<tr>
                						<td colspan="2">
                							<p id="caste_certificate_number_check"></p>
                						</td>
                					</tr>

                					<tr>
                						<td class="text-right">
                							<label class="form-label" for="photo">Upload Caste Certificate:</label>
                						</td>
                						<td class="text-left">
											<input onchange="casteCertificateValidation()" id="photo" type="file" name="caste_certificate" accept="image/*"><br>
                						</td>
                					</tr>
	                        	...
	                        	<input class="btn btn-success mt-2" type="submit" name="upload_photo" value="Upload Certificate">
                        	</form>

                        	<%
						  		if(student_caste_certificate.exists())
						  		{
						  	%>
	                        	<img class="img-fluid mt-3 border" src="../uploads/images/student_caste_certificate/<%=applicant_id%>.png?photoCache=<%=photoCache%>" alt="Photo" width="200" height="250"><br>
	                        	<button class="btn btn-info mt-4" onclick="openCasteCertificate()">View Caste Certificate</button>

	                        	<!-- Modal -->
								<div id="caste_certificate_open" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
								  <div class="modal-dialog">

								    <!-- Modal content-->
								    <div class="modal-content">
								      <div class="modal-header">
								        <div class="modal-title text-center">Caste Certificate</div>
								        <button type="button" class="close" data-dismiss="modal">&times;</button>
								      </div>
								      <div class="modal-body">
								        <img class="img-fluid mt-3" src="../uploads/images/student_caste_certificate/<%=applicant_id%>.png?photoCache=<%=photoCache%>" alt="Photo" width="1000" height="1000">
								      </div>
								      <div class="modal-footer">
								        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
								      </div>
								...
								<script type="text/javascript">
									function openCasteCertificate()
									{
										$("#caste_certificate_open").modal();
									}
								</script>
                        	<%
						  		}
		...
		<script src="../js/main_application_upload_caste_certificate.js"></script>	
	</body>
</html>