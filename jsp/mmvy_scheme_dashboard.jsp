		...
		<div class="container border mb-4">
			<div class="container mt-4 mb-4">
				<div class="alert alert-success text-center">
					...
					<h5 class="text-primary">Mukhyamantri Medhavi Vidhyarthi Yojana</h5>
					<h2 class="border border-info">Schemes Benefits</h2>
					<h5 class="text-primary">This Scheme is for the Student who has got more than 70% of marks in 12th Examination.</h5>
				</div>
			</div>
