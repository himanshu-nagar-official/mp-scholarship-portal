...
<html lang="en">
	...
	<body>
				...
				<div class="col-md-10">
					<div class="card">
						<div class="card-header">
							Take or Upload Your Photo  in JPG / JPEG / PNG format
						</div>
						<div class="card-body text-center">
					  		<div class="alert alert-primary text-center">
								<h6>
									HELP - Please Take or UPLOAD Scanned copy of Your photo. Photo MUST BE CLEAR and RECENT (must NOT be older than 90 days). Photo Image size should be less than 100 KB. Image file Format JPG / JPEG Or PNG.
								</h6>
							</div>

							<hr>

							<!--If Photo Uploaded Successfully Show Modal-->
							<%
								if(request.getAttribute("message")!=null)
								{
							%>
									<!-- Modal -->
									<div id="student_photo_uploaded_successfull" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
									  <div class="modal-dialog">

									    <!-- Modal content-->
									    <div class="modal-content">
									      <div class="modal-header alert alert-success">
									        <div class="modal-title text-center">Message : Student Photo</div>
									...
									<script type="text/javascript">
										$("#student_photo_uploaded_successfull").modal();
									</script>
							<%
								}
							%>
                			...
                			<img class="border border-primary" id="photopre" src="../static/images/avatar.gif" width="150" height="170"></br>

                			<!--Take a Photo Button-->
                			<button type="button" class="btn btn-primary mt-3" data-toggle="modal" data-target="#myModal">Take a Photo</button>

                			<p class="mt-2">Or</p>

                			<!--Student Photo Upload Form-->
                			<form method="post" onsubmit="return check_photo()" action="Upload_Student_Photo" enctype="multipart/form-data">
                				<!--Input Type File for Student Photo-->
	                			<input onchange="photopath(event)" id="photo" type="file" name="photo" accept="image/*">

	                			<!--If Photo Captured by Camera Store Captured Pic Data-->
	                        	<input type="hidden" name="captured" id="captured_pic"><br>

	                        	<!--To send Scheme Id with Request-->
	                        	<input type="hidden" name="scheme_id" value="<%=scheme_id%>">

	                        	<!--Upload Photo Button-->
	                        	<input class="btn btn-success mt-2" type="submit" name="upload_photo" value="Upload Photo">
                        	</form>

                        	<!--If Student Photo Available - Show Current Photo-->
                        	<%
						  		if(student_photo.exists())
						  		{
						  	%>
	                        	<img class="img-fluid mt-3" src="../uploads/images/student_photos/<%=applicant_id%>.png?photoCache=<%=photoCache%>" alt="Photo" width="200" height="250">
                        	<%
						  		}
						  	%>
						</div>
			    ...
			    <div class="modal-content">
			    	<div class="modal-header">
			      	...
			      	<div class="modal-body text-center">
			        	...
			        	<button type="button" id="capture" class="btn btn-primary mt-3" onclick="take_photo()" style="display: none;">Take Photo</button>
			        	<canvas id="canvas" style="display: none;"></canvas>
			        	<button type="button" id="camera" class="btn btn-primary mt-3" onclick="access_camera()">Start Camera</button></br>
			        	<img id="photopre2" class="mt-3" src="../static/images/avatar.gif" width="150" height="170" style="border: 2px solid #555;">
			        	<button type="button" id="final" onclick="final_snap()" class="btn btn-primary mt-3" style="display: none;">Final This Photo</button>
			      	</div>
		...
		<script src="../js/main_application_upload_student_photo.js"></script>	
	</body>
</html>