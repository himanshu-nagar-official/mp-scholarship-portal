...
<%
	...
	{  
		...
		if(con != null && !con.isClosed())
		{
			...
			if(student_category.equals("General")||student_category.equals("Economically Weaker Section"))
			{
...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../css/scheme_dashboard.css">
		<!--jQuery Imports-->
		<script src="../js/jquery-3.5.1.slim.js"></script>
		<!--Bootstrap JavaScript Imports-->
		<script src="../js/popper.min.js"></script>
		<script src="../js/bootstrap.min.js"></script>
		<!--Google Recaptcha JavaScript Imports-->
		...
		<div class="container border mb-4">
			<div class="container mt-4 mb-4">
				<div class="alert alert-success text-center">
					<h2 class="border border-info">Welcome!!!</h2>
					<h5 class="text-primary">Post Metric Scholarship</h5>
					<h2 class="border border-info">Schemes Benefits</h2>
					<h5 class="text-primary">SC, ST, OBC & Nomadic/Semi-Nomadic/De-Notified tribes can apply for this scheme.</h5>
				</div>
			</div>
			<h6 class="text-left text-dark">Get Your Schemes/Application Information Here</h6>
			<div class="container border mt-0 mb-4 pl-0 pr-0">
				<div class="alert alert-danger text-left">
					<span><i class="fas fa-question-circle"></i>  <b>Application Management</b></span>
				</div>
				<ul>
					<li>
						<a class="app-management-links" href="main_application_profile.jsp?scheme_id=<%=scheme_id%>">Apply Online</a>
					</li>
					<li>
						<a class="app-management-links" href="track_application.jsp">Application Status</a>
					</li>
				</ul>
			</div>
		</div>
